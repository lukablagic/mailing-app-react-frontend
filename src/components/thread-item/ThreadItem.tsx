...
export const ThreadItem = ({ thread }: ThreadProps) => {
  return (
    <div className="p-2 px-3 mx-2 cursor-pointer rounded-md text-gray-300 hover:bg-gray-400 hover:text-white">
      <div className="flex flex-row items-center ">
        <div className="flex flex-col w-full">
          <div className="flex flex-row items-center justify-start gap-2 ">
              {thread.is_read === 1 ? <MailIcon className="text-gray-500 fill-white p-0 m-0" height={20} width={20}/> : <OpenLetter className="text-gray-500 fill-white p-0 m-0" height={18} width={18}/>}
